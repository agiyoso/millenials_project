...
<body>
	...
	<header>
		<div class="container">
			<h1><a href="dashboard.php">Millenials.Sply</a></h1>
			<ul>
				<li><a href="dashboard.php">Millenials.Sply</a></li>
		...
		<div class="container">
			...
			<div class="box">
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<input type="text" name="stok" class="input-control" placeholder="Stok Produk" value="<?php echo $p->product_stock ?>" required>
	...
	<footer>
		<div class="container">
			<small>Copyright &copy; 2022 - akhmad.</small>
		</div>
	</footer>
	<script>
